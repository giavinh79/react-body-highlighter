import { EModel, EMuscleType, IMuscleData } from '../component/metadata';

export const DEFAULT_MUSCLE_DATA: Record<EMuscleType, IMuscleData> = {
...
export const DEFAULT_MODEL_TYPE = EModel.ANTERIOR;